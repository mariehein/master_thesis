...
# MAF stuff
"""
#import_and_plot("roc_cathode_averaging", label="MAF one run", color="C0", folder="results/cathode/cathode_MAF_avg/")
...
#import_and_plot("roc_cathode_averaging", label="MAF avg", color="C0", folder="results/cathode/cathode_MAF_avg/")
#import_and_plot("roc_cathode_averaging", label="MAF ens", color="C1", folder="results/cathode/cathode_MAF_ens/")
#import_and_plot("roc_cathode_averaging", label="MAF", color="C2", folder="results/cathode/cathode_MAF_no/")
"""
...
if envelope:
	...
	plt.savefig("plots/combined/roc_example.pdf")
plt.show()
